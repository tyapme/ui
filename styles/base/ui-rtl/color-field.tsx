...
function ColorFieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      className={cn(
        "t-input relative flex h-9 w-full items-center overflow-hidden rounded-md border border-input bg-transparent shadow-xs transition-[color,box-shadow] outline-none",
...
function ColorFieldPrefix({
  ...
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 items-center ps-3 text-muted-foreground [&+[data-slot=color-field-input]]:ps-2",
        className
      )}
      {...props}
    />
...
function ColorFieldSuffix({
  ...
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 items-center pe-3 text-muted-foreground",
        className
      )}
      {...props}
    />
