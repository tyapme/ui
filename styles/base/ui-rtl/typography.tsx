...
export function TypographyUL({
  ...
  return (
    <ul className={cn("my-6 ms-6 list-disc [&>li]:mt-2", className)} {...props}>
      {children}
    </ul>
  )
}
...
export function TypographyOL({
  ...
  return (
    <ol
      className={cn("my-6 ms-6 list-decimal [&>li]:mt-2", className)}
      {...props}
    >
      {children}
    </ol>
...
export function TypographyTH({
  ...
  return (
    <th
      className={cn(
        "border-e border-b bg-muted/70 px-4 py-3 text-start font-semibold text-muted-foreground first:rounded-ss-[calc(var(--radius-2xl)-1px)] last:rounded-se-[calc(var(--radius-2xl)-1px)] last:border-e-0 [&[align=center]]:text-center [&[align=right]]:text-end",
        className
      )}
      {...props}
    >
...
export function TypographyTD({
  ...
  return (
    <td
      className={cn(
        "border-e border-b border-border/60 px-4 py-3 text-start align-top text-foreground/90 last:border-e-0 [&[align=center]]:text-center [&[align=right]]:text-end",
        className
      )}
      {...props}
    >
